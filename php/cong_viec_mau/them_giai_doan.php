...
$ten_cong_viec_mau = filter_input(INPUT_POST, "ten_cong_viec_mau");
$noi_dung_cong_viec_mau = filter_input(INPUT_POST, "noi_dung_cong_viec_mau");
$du_an = filter_input(INPUT_POST, "du_an");
$giai_doan_mau = filter_input(INPUT_POST, "giai_doan_mau");
