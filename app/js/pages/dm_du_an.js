...
var ma_cong_viec_du_an_dang_sua = "null";
...
var ma_cong_viec_du_an_vua_thao_tac = "null";
...
function cai_dat_select_cho_them_cong_viec_dialog() {
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_du_an_cong_viec.php", "#du_an", "MA_DU_AN", "TEN_DU_AN", "Không lấy được danh sách dự án. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_don_vi_yeu_cau.php", "#don_vi_yeu_cau", "MA_DON_VI_YEU_CAU", "TEN_DON_VI_YEU_CAU", "Không lấy được danh sách dự án. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_do_uu_tien.php", "#do_uu_tien", "MA_MUC_DO_UU_TIEN", "MUC_DO_UU_TIEN", "Không lấy được danh sách độ ưu tiên. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_nhom_tai_khoan.php", "#nhom_tai_khoan", "MA_NHOM_TAI_KHOAN", "TEN_NHOM_TAI_KHOAN", "Không lấy được danh sách nhóm. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_trang_thai.php", "#trang_thai", "MA_TRANG_THAI_CONG_VIEC", "TEN_TRANG_THAI_CONG_VIEC", "Không lấy được danh sách trạng thái. Vui lòng liên hệ Admin!");
    ...
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_don_vi_yeu_cau.php", "#don_vi_yeu_cau_tim_nang_cao", "MA_DON_VI_YEU_CAU", "TEN_DON_VI_YEU_CAU", "Không lấy được danh sách dự án. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_do_uu_tien.php", "#do_uu_tien_tim_nang_cao", "MA_MUC_DO_UU_TIEN", "MUC_DO_UU_TIEN", "Không lấy được danh sách độ ưu tiên. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_nhom_tai_khoan.php", "#nhom_tai_khoan_tim_nang_cao", "MA_NHOM_TAI_KHOAN", "TEN_NHOM_TAI_KHOAN", "Không lấy được danh sách nhóm. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_trang_thai.php", "#trang_thai_tim_nang_cao", "MA_TRANG_THAI_CONG_VIEC", "TEN_TRANG_THAI_CONG_VIEC", "Không lấy được danh sách trạng thái. Vui lòng liên hệ Admin!");
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_xu_ly.php?ma_nhom_tai_khoan=TAT_CA", "#tai_khoan_tao_tim_nang_cao", "MA_TAI_KHOAN", "TEN_HIEN_THI", null);
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_xu_ly.php?ma_nhom_tai_khoan=TAT_CA", "#tai_khoan_xu_ly_tim_nang_cao", "MA_TAI_KHOAN", "TEN_HIEN_THI", null);
    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_tham_dinh_theo_tai_khoan_xu_ly.php?ma_tai_khoan_xu_ly=TAT_CA&ma_nhom_tai_khoan=TAT_CA", "#tai_khoan_tham_dinh_tim_nang_cao", "MA_TAI_KHOAN_THAM_DINH", "TEN_HIEN_THI", null);

    cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_ds_loai_cong_viec.php", "#loai_cv", "ID_LOAI", "TEN_LOAI", "Không lấy được danh sách loại công việc. Vui lòng liên hệ Admin!");
    //var thoi_gian_bat_dau = $("#thoi_gian_bat_dau").val();
    // cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/doGet.php?txtAction=getLoaiCongViec&thoi_gian_bat_dau=" + thoi_gian_bat_dau , "#loai_cv", "MA_LOAI_CV", "TEN_LOAI_CV", null);
    //cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/doGet.php?txtAction=getLoaiCongViec&thoi_gian_bat_dau=" + thoi_gian_bat_dau , "#loai_cv", "ID_LOAI", "TEN_LOAI", null);
    //cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/doGet.php?txtAction=getLoaiCongViec , "#loai_cv", "ID_LOAI", "TEN_LOAI", null);
...
function init_cong_viec() {
    ...
    $('#cong_viec_du_an_dt').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    if (ma_cong_viec_du_an_vua_thao_tac !== "null") {

                        $("#cong_viec_du_an_dt").DataTable().ajax.url('php/dm_du_an/lay_danh_sach_cong_viec.php?trang_thai_cong_viec=TAT_CA&ma_nhom_tai_khoan=TAT_CA&ngay_them_1=01/01/1000&ngay_them_2=31/12/3000&muc_do_uu_tien=TAT_CA&ma_du_an=TAT_CA&ma_tai_khoan_so_huu=TAT_CA&ma_tai_khoan_xu_ly=TAT_CA&ma_tai_khoan_tham_dinh=TAT_CA&ma_cong_viec_cha=TAT_CA&ma_don_vi_yeu_cau=TAT_CA&cong_viec_dang_xu_ly=1&ma_cong_viec_du_an=TAT_CA&ma_cong_viec_du_an=' + ma_cong_viec_du_an_vua_thao_tac).load();
                        //search_cell_by_column_name("#cong_viec_du_an_dt", "MA_CONG_VIEC_DU_AN", ma_cong_viec_du_an_vua_thao_tac);
                    }
                    else {
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    var table = $("#cong_viec_du_an_dt").DataTable();
                    clear_search_all("#cong_viec_du_an_dt");
                    $("#cong_viec_du_an_dt").DataTable().ajax.url('php/dm_du_an/lay_danh_sach_cong_viec.php?trang_thai_cong_viec=TAT_CA&ma_nhom_tai_khoan=TAT_CA&ngay_them_1=01/01/1000&ngay_them_2=31/12/3000&muc_do_uu_tien=TAT_CA&ma_du_an=TAT_CA&ma_tai_khoan_so_huu=TAT_CA&ma_tai_khoan_xu_ly=TAT_CA&ma_tai_khoan_tham_dinh=TAT_CA&ma_cong_viec_cha=TAT_CA&ma_don_vi_yeu_cau=TAT_CA&cong_viec_dang_xu_ly=1&ma_cong_viec_du_an=TAT_CA').load();
        ...
        //serverSide: true,
        ajax: {
            url: "php/dm_du_an/lay_danh_sach_cong_viec.php?trang_thai_cong_viec=TAT_CA&ma_nhom_tai_khoan=TAT_CA&ngay_them_1=01/01/1000&ngay_them_2=31/12/3000&muc_do_uu_tien=TAT_CA&ma_du_an=TAT_CA&ma_tai_khoan_so_huu=TAT_CA&ma_tai_khoan_xu_ly=TAT_CA&ma_tai_khoan_tham_dinh=TAT_CA&ma_cong_viec_cha=TAT_CA&ma_don_vi_yeu_cau=TAT_CA&cong_viec_dang_xu_ly=1&ma_cong_viec_du_an=TAT_CA",
            type: "get",
            error: function () {
                $("#cong_viec_du_an_dt").css('display', 'none');
            }
        },
        scrollX: true,
        scrollCollapse: true,
        columnDefs: [
            ...
            // { targets: 2, width: 300 },  // TEN_CONG_VIEC_DU_AN
            // { targets: 3, width: 400 },  // NOI_DUNG_CONG_VIEC_DU_AN 
            // { targets: 4, width: 70 },  // TEN_LOAI
            // { targets: 5, width: 150 },  // TEN_DON_VI_YEU_CAU           
            // { targets: 6, width: 70 },  // TEN_TRANG_THAI_CONG_VIEC
            // { targets: 7, width: 60 },  // TI_LE_HOAN_THANH_CONG_VIEC
            // { targets: 8, width: 70 },  // MUC_DO_UU_TIEN 
            // { targets: 9, width: 40 },  // THANG_CUA_CONG_VIEC 
            // { targets: 10, width: 60 },  // THOI_GIAN_BAT_DAU_CONG_VIEC
            // { targets: 11, width: 60 },  // THOI_GIAN_KET_THUC_CONG_VIEC
            // { targets: 12, width: 100 },  // TEN_TAI_KHOAN_XU_LY
            // { targets: 13, width: 100 },  // TEN_NHOM_TAI_KHOAN
            // { targets: 14, width: 100 },  // THAM_DINH_THOI_GIAN_HT_CV
            // // { targets: 15, width: 100 },  // THOI_GIAN_CON_LAI
            // { targets: 16, width: 120 },  // THAM_DINH_DA_HOAN_THANH_CV
            // { targets: 17, width: 110 },  // DIEM_CHAT_LUONG
            // { targets: 18, width: 110 },  // DIEM_THAI_DO
            // { targets: 19, width: 130 },  // THAM_DINH_TONG_THOI_GIAN
            // { targets: 20, width: 100 },  // TEN_TAI_KHOAN
            // { targets: 21, width: 100 },  // TEN_TAI_KHOAN_THAM_DINH
            // { targets: 22, width: 100 },  // TEN_TAI_KHOAN_DG_CHAT_LUONG
            // { targets: 23, width: 100 }  // TEN_TAI_KHOAN_DG_THAI_DO
        ],
        fixedColumns: true,
        columns: [
            ...
            { title: "Tên đơn vị", data: "TEN_DON_VI_YEU_CAU", name: "TEN_DON_VI_YEU_CAU" },
            ...
            { title: "Tên nhóm", data: "TEN_NHOM_TAI_KHOAN", name: "TEN_NHOM_TAI_KHOAN" },
        ...
        rowCallback: function (row, data, index) {
            ...
            if (ma_tai_khoan_session === data.MA_TAI_KHOAN) {
                $('td:eq(' + fixed_td_index(table, "TEN_CONG_VIEC_DU_AN") + ')', row).html('<div><i class="material-icons pointer orange">edit</i><span>' + data.TEN_CONG_VIEC_DU_AN + '</span></div>').find("i").click(function () {
                    //alert(data.MA_DON_VI_YEU_CAU);
                    chinh_sua_cong_viec( data.TEN_CONG_VIEC_DU_AN, data.NOI_DUNG_CONG_VIEC_DU_AN, data.MA_DU_AN, data.MA_DON_VI_YEU_CAU, data.MA_MUC_DO_UU_TIEN, data.MA_NHOM_TAI_KHOAN, data.THOI_GIAN_BAT_DAU_CONG_VIEC, data.THOI_GIAN_KET_THUC_CONG_VIEC, data.MA_CONG_VIEC_DU_AN, data.MA_TAI_KHOAN_XU_LY, data.MA_TAI_KHOAN_THAM_DINH, data.ID_LOAI);
                });
            }
            else {
                $('td:eq(' + fixed_td_index(table, "TEN_CONG_VIEC_DU_AN") + ')', row).html('<div><i class="material-icons pointer lightskyblue">info</i><span>' + data.TEN_CONG_VIEC_DU_AN + '</span></div>').find("i").click(function () {
                    xem_thong_tin_cong_viec( data.TEN_CONG_VIEC_DU_AN, data.NOI_DUNG_CONG_VIEC_DU_AN, data.MA_DU_AN, data.MA_DON_VI_YEU_CAU, data.MA_MUC_DO_UU_TIEN, data.MA_NHOM_TAI_KHOAN, data.THOI_GIAN_BAT_DAU_CONG_VIEC, data.THOI_GIAN_KET_THUC_CONG_VIEC, data.MA_CONG_VIEC_DU_AN, data.MA_TAI_KHOAN_XU_LY, data.MA_TAI_KHOAN_THAM_DINH, data.ID_LOAI);
                });
            }
            ...
            if (ma_tai_khoan_session === data.MA_TAI_KHOAN_XU_LY && data.MA_TRANG_THAI_CONG_VIEC !== "3") {
                $('td:eq(' + fixed_td_index(table, "TEN_TRANG_THAI_CONG_VIEC") + ')', row).html('<span class="label ' + label_class + ' pointer">' + data.TEN_TRANG_THAI_CONG_VIEC + ' </span>').find("span").click(function () {
                    hoan_thanh_cong_viec(data.MA_CONG_VIEC_DU_AN, data.TEN_CONG_VIEC_DU_AN);
                });
            }
            else {
        ...
        drawCallback: function () {
            ...
            $.contextMenu({
                ...
                items: {
                    ...
                    xem_cay_cong_viec: {
                        name: "Xem cây công việc", icon: "cay-cong-viec",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    xoa: {
                        name: "Xóa công việc", icon: "delete",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    cap_nhat_ti_le: {
                        name: "Cập nhật tỉ lệ hoàn thành", icon: "ti-le",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    hoan_thanh: {
                        name: "Hoàn thành công việc", icon: "trang-thai",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    nhan_xu_ly: {
                        name: "Nhận xử lý công việc", icon: "accept",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    tu_choi: {
                        name: "Từ chối công việc", icon: "cancel",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    tham_dinh: {
                        name: "Thẩm định hoàn thành công việc", icon: "tham-dinh",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    tham_dinh_tong_thoi_gian: {
                        name: "Thẩm định tổng thời gian", icon: "tham-dinh",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                    ...
                    tham_dinh_chua_hoan_thanh: {
                        name: "Thẩm định chưa hoàn thành công việc", icon: "tham-dinh",
                        disabled: function (key, options) {
                            var row_index = options.$trigger[0]._DT_CellIndex["row"];
                            var column_index = options.$trigger[0]._DT_CellIndex["column"];
                ...
                callback: function (key, options) {
                    ...
                    ma_cong_viec_du_an_vua_thao_tac = table.cell(row_index, table.column('MA_CONG_VIEC_DU_AN:name').index()).data();

                    switch (key) {
                        case "xem_cong_viec":
                            {
                                ma_cong_viec_du_an_dang_sua = table.cell(row_index, table.column('MA_CONG_VIEC_DU_AN:name').index()).data();
                                ...
                                $("#them_cong_viec_dialog_title").text("Thông tin công việc: " + table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data());
                                $("#ten_cong_viec_du_an").val(table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data());
                                var noi_dung_cong_viec_du_an = table.cell(row_index, table.column('NOI_DUNG_CONG_VIEC_DU_AN:name').index()).data();
                                $("#noi_dung_cong_viec_du_an").val(noi_dung_cong_viec_du_an);
                                ...
                                $("#ten_cong_viec_du_an").parent().addClass('focused');
                                $("#noi_dung_cong_viec_du_an").parent().addClass('focused');
                                $("#them_cong_viec_dialog").modal("show");
                        ...
                        case "chinh_sua":
                            {
                                ...
                                var ten_cong_viec_du_an = table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data();
                                var noi_dung_cong_viec_du_an = table.cell(row_index, table.column('NOI_DUNG_CONG_VIEC_DU_AN:name').index()).data();
                                ...
                                var ma_cong_viec_du_an = table.cell(row_index, table.column('MA_CONG_VIEC_DU_AN:name').index()).data();
                                ...
                                var id_loai = table.cell(row_index, table.column('ID_LOAI:name').index()).data();


                                chinh_sua_cong_viec(ten_cong_viec_du_an, noi_dung_cong_viec_du_an, du_an, don_vi_yeu_cau, do_uu_tien, nhom_tai_khoan, thoi_gian_bat_dau, thoi_gian_ket_thuc, ma_cong_viec_du_an, tai_khoan_xu_ly, tai_khoan_tham_dinh, id_loai);
                                break;
                            }
                        case "them_nhanh":
                            {
                                ma_cong_viec_cha = table.cell(row_index, table.column('MA_CONG_VIEC_DU_AN:name').index()).data();
                                ...
                                $('#nhom_tai_khoan').prop("disabled", false);
                                $('#tai_khoan_tham_dinh').prop("disabled", false);
                                $("#them_cong_viec_dialog_title").text("Thêm nhánh cho công việc: " + table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data());
                                $("#them_cong_viec_dialog").modal("show");
                        ...
                        case "xoa":
                            {
                                ...
                                swal({
                                    title: "Xóa công việc: " + ten_cong_viec_du_an,
                                    text: "",
                                    type: "warning",
                                    ...
                                    if (isConfirm) {
                                        $.post("php/dm_du_an/xoa_cong_viec.php",
                                            {
                                                ma_cong_viec_du_an: ma_cong_viec_du_an
                                            }).done(function (data) {
                                                handle_data_json(data, null,
                                                    function (obj, other_obj) {
                                                        if (obj[0].MA_CONG_VIEC_DU_AN !== null) {
                                                            $("#cong_viec_du_an_dt").DataTable().ajax.reload();
                                                            lay_so_luong_cong_viec_cua_toi();
                                                            lay_so_luong_cong_viec_lien_quan();
                                                            lay_so_luong_cong_viec_can_tham_dinh();
                        ...
                        case "hoan_thanh":
                            {
                                var ma_cong_viec_du_an = table.cell(row_index, table.column('MA_CONG_VIEC_DU_AN:name').index()).data();
                                var ten_cong_viec_du_an = table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data();
                                hoan_thanh_cong_viec(ma_cong_viec_du_an, ten_cong_viec_du_an);
                                break;
                            }
                        ...
                        case "huy_cong_viec":
                            {
                                ...
                                var ten_cong_viec_du_an = table.cell(row_index, table.column('TEN_CONG_VIEC_DU_AN:name').index()).data();
                                swal({
                                    title: "Nhận xử lý công việc: " + ten_cong_viec_du_an,
                                    ...
                                    preConfirm: () => {
                                        ...
                                        $.post("php/dm_du_an/cap_nhat_trang_thai_cong_viec.php",
                                            {
                                                ma_cong_viec_du_an: ma_cong_viec_du_an,
                        ...
                        case "tham_dinh":
                            {
                                ...
                                tham_dinh_cong_viec(ma_cong_viec_du_an, ten_cong_viec_du_an, thoi_gian_ket_thuc);
                                break;
                            }
                        ...
                        case "tham_dinh_chua_hoan_thanh":
                            {
                                ...
                                swal({
                                    title: "Thẩm định công việc: " + ten_cong_viec_du_an,
                                    showCancelButton: true,
                                    confirmButtonColor: "##fb483a",
                                    ...
                                    if (isConfirm) {
                                        $.post("php/dm_du_an/tham_dinh_chua_hoan_thanh_cong_viec.php",
                                            {
                                                ma_cong_viec_du_an: ma_cong_viec_du_an
                                            }).done(function (data) {
                                                handle_data_json(data, null,
                        ...
                        case "danh_gia_chat_luong":
                            {
                                ...
                                danh_gia_chat_luong(ma_cong_viec_du_an, ten_cong_viec_du_an);
                                break;
                            }
                        case "danh_gia_thai_do":
                            {
                                ...
                                danh_gia_thai_do(ma_cong_viec_du_an, ten_cong_viec_du_an);
                                break;
                            }
                        case "xem_cay_cong_viec":
                            {
                                ...
                                xem_cau_cong_viec(ma_cong_viec_du_an, ma_cong_viec_cha, so_luong_cong_viec_con);
                                break;
                            }
                    }
                }
    ...
    $('#cong_viec_du_an_dt tbody').on('click', 'tr', function () {
        $(this).toggleClass('selected');
    });

    $('#cong_viec_du_an_dt').on('processing.dt', function (e, settings, processing) {
    ...
    */
    ...
    $("#du_an").change(function () {
        ...
        cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/doGet.php?txtAction=lay_danh_sach_don_vi_yeu_cau&du_an=" + du_an, "#don_vi_yeu_cau", "MA_DON_VI_YEU_CAU", "TEN_DON_VI_YEU_CAU", "Không lấy được danh sách đơn vị yêu cầu. Vui lòng liên hệ Admin!");
        //cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_don_vi_yeu_cau.php", "#don_vi_yeu_cau", "MA_DON_VI_YEU_CAU", "TEN_DON_VI_YEU_CAU", "Không lấy được danh sách dự án. Vui lòng liên hệ Admin!");
    });
    ...
    $("#nhom_tai_khoan").change(function () {
        ...
        cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_xu_ly.php?ma_nhom_tai_khoan=" + ma_nhom_tai_khoan, "#tai_khoan_xu_ly", "MA_TAI_KHOAN", "TEN_HIEN_THI", null);

        if (ma_tai_khoan_xu_ly === null) return;
        cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_tham_dinh_theo_tai_khoan_xu_ly.php?ma_tai_khoan_xu_ly=" + ma_tai_khoan_xu_ly + "&ma_nhom_tai_khoan=" + ma_nhom_tai_khoan, "#tai_khoan_tham_dinh", "MA_TAI_KHOAN", "TEN_HIEN_THI", null);
    });
    ...
    $("#tai_khoan_xu_ly").change(function () {
        ...
        if (ma_nhom_tai_khoan === null) return;
        if (ma_tai_khoan_xu_ly === null) return;
        cai_dat_select_cho_them_cong_viec_dialog1("php/dm_du_an/lay_danh_sach_tai_khoan_tham_dinh_theo_tai_khoan_xu_ly.php?ma_tai_khoan_xu_ly=" + ma_tai_khoan_xu_ly + "&ma_nhom_tai_khoan=" + ma_nhom_tai_khoan, "#tai_khoan_tham_dinh", "MA_TAI_KHOAN_THAM_DINH", "TEN_HIEN_THI", null);
    });
    ...
    $("#luu_cong_viec_btn").click(function () {
        ...
        var ten_cong_viec_du_an = $("#ten_cong_viec_du_an").val();
        var noi_dung_cong_viec_du_an = $("#noi_dung_cong_viec_du_an").val();
        var du_an = $("#du_an").val();
        var don_vi_yeu_cau = $("#don_vi_yeu_cau").val();
        ...
        if (ten_cong_viec_du_an === null || noi_dung_cong_viec_du_an === null || du_an === null || don_vi_yeu_cau === null || do_uu_tien === null
            || (nhom_tai_khoan === null && dang_them_moi_cong_viec) || (tai_khoan_xu_ly === null && dang_them_moi_cong_viec)
            || (tai_khoan_tham_dinh === null && dang_them_moi_cong_viec) ) {
            showNotification("bg-red", "Vui lòng nhập đầy đủ thông tin!", "bottom", "right", "", "");
            return;
        }

        if (ten_cong_viec_du_an.trim() === "" || noi_dung_cong_viec_du_an.trim() === "" || du_an.trim() === ""
            || do_uu_tien.trim() === "" /*|| don_vi_yeu_cau.trim() === "" */|| (nhom_tai_khoan.trim() === "" && dang_them_moi_cong_viec)
        ...
        if (dang_them_moi_cong_viec) {
            $.post("php/dm_du_an/them_cong_viec.php",
                {
                    ma_cong_viec_cha: ma_cong_viec_cha,
                    ten_cong_viec_du_an: ten_cong_viec_du_an,
                    noi_dung_cong_viec_du_an: noi_dung_cong_viec_du_an,
                    du_an: du_an,
                    ...
                    handle_data_json(data, null,
                        function (obj, other_obj) {
                            if (obj[0].MA_CONG_VIEC_DU_AN !== null) {
                                ...
                                $("#ten_cong_viec_du_an").val("");
                                $("#noi_dung_cong_viec_du_an").val("");
                                $("#ten_cong_viec_du_an").focusout();
                                $("#noi_dung_cong_viec_du_an").focusout();
                                $("#du_an").val("").change();
                                ...
                                ma_cong_viec_du_an_vua_thao_tac = obj[0].MA_CONG_VIEC_DU_AN;
        ...
        else  // sua cong viec
        {
            ...
            $.post("php/dm_du_an/sua_cong_viec.php",
                {
                    ma_cong_viec_du_an: ma_cong_viec_du_an_dang_sua,
                    ten_cong_viec_du_an: ten_cong_viec_du_an,
                    noi_dung_cong_viec_du_an: noi_dung_cong_viec_du_an,
                    du_an: du_an,
                    don_vi_yeu_cau: don_vi_yeu_cau.join(','),
...
function tim_nang_cao() {
    $("#tim_cong_viec_nang_cao_button").click(function () {
        ...
        clear_search_all("#cong_viec_du_an_dt");
        $("#cong_viec_du_an_dt").DataTable().ajax.url('php/dm_du_an/lay_danh_sach_cong_viec.php?trang_thai_cong_viec=' + trang_thai + '&ma_nhom_tai_khoan=' + nhom_tai_khoan + '&ngay_them_1=' + ngay_them_1 + '&ngay_them_2=' + ngay_them_2 + '&muc_do_uu_tien=' + do_uu_tien + '&ma_du_an=' + du_an + '&ma_tai_khoan_so_huu=' + tai_khoan_tao + '&ma_tai_khoan_xu_ly=' + tai_khoan_xu_ly + '&ma_tai_khoan_tham_dinh=' + tai_khoan_tham_dinh + '&ma_cong_viec_cha=TAT_CA&ma_don_vi_yeu_cau=' + don_vi_yeu_cau + '&cong_viec_dang_xu_ly=0&ma_cong_viec_du_an=TAT_CA').load();
...
function loop_truy_cap_tai_khoan_trong_danh_sach(ma_tai_khoan) {
    if (loaded_menu_list.includes("tai_khoan")) {
        $("#tai_khoan_dt").DataTable().ajax.url('php/dm_du_an/lay_danh_sach_tai_khoan.php?ma_tai_khoan=' + ma_tai_khoan).load();
    }
    else {
        setTimeout(function () {
            loop_truy_cap_tai_khoan_trong_danh_sach(ma_tai_khoan);
...
function tham_dinh_cong_viec(ma_cong_viec_du_an, ten_cong_viec_du_an, thoi_gian_ket_thuc) {
    swal({
        ...
        $.post("php/dm_du_an/tham_dinh_hoan_thanh_cong_viec.php",
            {
                ma_cong_viec_du_an: ma_cong_viec_du_an,
...
function hoan_thanh_cong_viec1(ma_cong_viec_du_an, ten_cong_viec_du_an) {
    swal({
        title: "Hoàn thành công việc: " + ten_cong_viec_du_an,
        showCancelButton: true,
        confirmButtonColor: "#2b982b",
...
function hoan_thanh_cong_viec(ma_cong_viec_du_an, ten_cong_viec_du_an) {
    swal({
        title: "Hoàn thành công việc: " + ten_cong_viec_du_an,
        showCancelButton: true,
...
function chinh_sua_cong_viec(ten_cong_viec_du_an, noi_dung_cong_viec_du_an, du_an, don_vi_yeu_cau, do_uu_tien,
    nhom_tai_khoan, thoi_gian_bat_dau, thoi_gian_ket_thuc, ma_cong_viec_du_an, tai_khoan_xu_ly,
    tai_khoan_tham_dinh, id_loai) {
    ma_cong_viec_du_an_dang_sua = ma_cong_viec_du_an;
    dang_them_moi_cong_viec = false;
    ...
    // }
    $("#them_cong_viec_dialog_title").text("Sửa thông tin công việc: " + ten_cong_viec_du_an);
    $("#ten_cong_viec_du_an").val(ten_cong_viec_du_an);
    $("#noi_dung_cong_viec_du_an").val(noi_dung_cong_viec_du_an);
    ...
    $("#ten_cong_viec_du_an").parent().addClass('focused');
    $("#noi_dung_cong_viec_du_an").parent().addClass('focused');
    $("#loai_cv").val(id_loai).trigger('change');

    $("#them_cong_viec_dialog").modal("show");
    $("#luu_cong_viec_btn").prop("disabled", false);
}

function xem_thong_tin_cong_viec(ten_cong_viec_du_an, noi_dung_cong_viec_du_an, du_an, don_vi_yeu_cau, do_uu_tien, nhom_tai_khoan, thoi_gian_bat_dau, thoi_gian_ket_thuc, ma_cong_viec_du_an, tai_khoan_xu_ly, tai_khoan_tham_dinh, loai_cv) {
    chinh_sua_cong_viec(ten_cong_viec_du_an, noi_dung_cong_viec_du_an, du_an, don_vi_yeu_cau, do_uu_tien, nhom_tai_khoan, thoi_gian_bat_dau, thoi_gian_ket_thuc, ma_cong_viec_du_an, tai_khoan_xu_ly, tai_khoan_tham_dinh, loai_cv);
    $("#them_cong_viec_dialog_title").text("Thông tin công việc: " + ten_cong_viec_du_an);
    $("#luu_cong_viec_btn").prop("disabled", true);
}
...
function tai_lai_danh_sach_cong_viec() {
    ...
    var table = $("#cong_viec_du_an_dt").DataTable();
    clear_search_all("#cong_viec_du_an_dt");
    $("#cong_viec_du_an_dt").DataTable().ajax.url('php/dm_du_an/lay_danh_sach_cong_viec.php?trang_thai_cong_viec=' + $("#trang_thai").val() + '&ma_nhom_tai_khoan=TAT_CA&ngay_them_1=01/01/1000&ngay_them_2=31/12/3000&muc_do_uu_tien=TAT_CA&ma_du_an=TAT_CA&ma_tai_khoan_so_huu=TAT_CA&ma_tai_khoan_xu_ly=TAT_CA&ma_tai_khoan_tham_dinh=TAT_CA&ma_cong_viec_cha=TAT_CA&ma_don_vi_yeu_cau=TAT_CA&cong_viec_dang_xu_ly=0&ma_cong_viec_du_an=TAT_CA').load();
    lay_so_luong_cong_viec_cua_toi();
    lay_so_luong_cong_viec_lien_quan();
    lay_so_luong_cong_viec_can_tham_dinh();
...
function lay_chuoi_ma_cong_viec_du_an_duoc_chon() {
    if (dang_load_danh_sach_cong_viec) {
        showNotification("bg-red", "Đang xử lý danh sách công việc!", "bottom", "right", "", "");
        return;
    }
    ...
    var table = $("#cong_viec_du_an_dt").DataTable();
    var chuoi_ma_cong_viec_du_an = ",";
    table.rows('.selected').every(function (rowIdx, tableLoop, rowLoop) {
        chuoi_ma_cong_viec_du_an += this.data().MA_CONG_VIEC_DU_AN + ",";
    });

    return chuoi_ma_cong_viec_du_an;
}

function tham_dinh_nhieu_cong_viec() {
    var chuoi_ma_cong_viec_du_an = lay_chuoi_ma_cong_viec_du_an_duoc_chon();
    if (chuoi_ma_cong_viec_du_an === ",") {
    ...
    swal({
        ...
        if (isConfirm) {
            $.post("php/dm_du_an/tham_dinh_cong_viec_hoan_thanh_dung_han.php",
                {
                    chuoi_ma_cong_viec_du_an: chuoi_ma_cong_viec_du_an
                }).done(function (data) {
                    handle_data_json(data, null,
                        function (obj, other_obj) {
                            if (obj[0].MA_CONG_VIEC_DU_AN !== null) {
