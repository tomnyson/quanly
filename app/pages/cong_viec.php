            ...
            <div class="card fixed-content" >
                <div class="header" id="congviec_header">                    
                    ...
                    <h2>
                        ...
                        <button type="button" title="Thêm công việc" class="btn bg-teal-button waves-effect" onclick=show_them_cong_viec_dialog()><i class="material-icons" style="color:white;">add</i><span>Thêm</span></button>
                        <button type="button" title="Tìm công việc vừa thao tác" class="btn bg-teal-button waves-effect" onclick=tim_cong_viec_vua_thao_tac()><i class="material-icons" style="color:white;">arrow_right_alt</i><span>CV vừa thao tác</span></button> 
                        <button type="button" title="Tìm công việc nhiều lựa chọn" class="btn bg-teal-button waves-effect" onclick=show_tim_kiem_nang_cao_dialog()><i class="material-icons" style="color:white;">search</i><span>Tìm công việc</span></button>
                        <button type="button" title="Thẩm định những công việc đã chọn hoàn thành đúng hạn" class="btn bg-teal-button waves-effect" onclick=tham_dinh_nhieu_cong_viec()><i class="material-icons" style="color:white;">check</i><span>Thẩm định</span></button>
                        <button type="button" title="Đánh giá chất lượng nhiều công việc" class="btn bg-teal-button waves-effect" onclick=danh_gia_chat_luong_nhieu_cong_viec()><i class="material-icons" style="color:white;">thumb_up</i><span>ĐG chất lượng</span></button>
                        <button type="button" title="Đánh giá thái độ nhiều công việc" class="btn bg-teal-button waves-effect" onclick=danh_gia_thai_do_nhieu_cong_viec()><i class="material-icons" style="color:white;">tag_faces</i><span>ĐG thái độ</span></button>
                        <button type="button" title="Thẩm định tổng thời gian nhiều công việc" class="btn bg-teal-button waves-effect" onclick=tham_dinh_tong_thoi_gian_nhieu_cong_viec()><i class="material-icons" style="color:white;">timer</i><span>Thẩm định TTG</span></button>
                    ...
                    <div style="margin-top:5" >
                       ...
                       <button type="button" title="Tải lại danh sách công việc" class="btn bg-teal-button waves-effect" onclick=tai_lai_danh_sach_cong_viec()><i class="material-icons" style="color:white;">refresh</i><span>Tải lại</span></button>
                    </div>

                </div>
                <div class="body">
                    <div>
                        <table id="cong_viec_dt" class="table table-bordered table-striped table-hover dataTable js-exportable">
                        <tfoot>
                        </tfoot>
                        </table>
                    </div>
                        ...
                        <form>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <select id="tai_khoan_tham_dinh" style="width: 100%" >
                                            </select> 
                                        </div>
                                    </div>                                        
                                </div>
